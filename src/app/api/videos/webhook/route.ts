...
export const POST = async (request: Request) => {
    console.log("check call webhook")
    if (!SIGNING_SECRET) {
    ...
    console.log("check val muxSignature: ", muxSignature);

    if (!muxSignature) {
        return new Response("Missing Mux Signature", {
            status: 401
        })
    }
    ...
    switch (payload.type as WebhookEvent["type"]) {
        ...
        case "video.asset.ready": {
            ...
            console.log("check val thumbnailUrl: ", thumbnailUrl);
